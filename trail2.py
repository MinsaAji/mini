...
os.chdir(r'C:\Users\minsa\OneDrive\Desktop\MINI PROJECT\MINI')
...
background_image = Image.open(r"C:\Users\minsa\OneDrive\Desktop\MINI PROJECT\mini\_4fbc0c76-24dd-45b8-ba51-5da32a87f93c.jpg")
background_image = background_image.resize((1920, 1080), Image.LANCZOS)
background_image = ImageTk.PhotoImage(background_image)

backy = Image.open(r"C:\Users\minsa\OneDrive\Desktop\MINI PROJECT\mini\grayy.jpeg")
...
next_button = tk.Button(main_frame, text="NEXT", command=switch_to_input_frame, font=("Times", 16), bg="gray", relief="flat")
next_button.pack()
next_button.place(x=700, y=700, width=80, height=50)
